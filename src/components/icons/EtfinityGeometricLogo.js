...
const EtfinityGeometricLogo = () => (
  <svg width="40" height="40" viewBox="0 0 63 73" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
    {/* Purple background for the logo */}
    <rect x="0" y="0" width="63" height="73" fill="#A78BFA" />
    {/* Black foreground for the logo shape */}
